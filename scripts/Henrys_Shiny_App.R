...
library(zoo)
library(randomcoloR)
#library(rphylopic) #trying to make the movement icons fish silhouette 
#library(ggimage)#trying to make the movement icons fish silhouette 
         ...
         tabPanel("Site Detection", 
           fluidRow(
            column(width = 7,
                   ...
                   plotlyOutput('bar_graph', height = "50vh") %>% 
