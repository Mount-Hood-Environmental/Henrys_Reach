...
ui <- fluidPage(theme = shinytheme("spacelab"),
  headerPanel( 
    fluidRow(column(width = 8, strong("Henry's Reach Complex - Lemhi River"), style = "font-size:50px;"), 
    ...
    fluidRow(column(width = 2, strong("in development"), style = "font-size:20px;"))), #Title Panel
